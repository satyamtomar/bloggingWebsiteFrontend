...
token:localStorage.getItem('token')
    ...
    DraftsAction.getDrafts(payload,(err,res)=>{
...
const handleRemove=async(draftID)=>{
    let payload={
        token:localStorage.getItem('token'),draft_id:draftID
     };
            DraftsAction.deleteFromDraft(payload,(err,res)=>{
